...
WOLFSSH_LOCAL int SendServiceRequest(WOLFSSH*, uint8_t);
WOLFSSH_LOCAL int SendServiceAccept(WOLFSSH*, uint8_t);
WOLFSSH_LOCAL int SendUserAuthRequest(WOLFSSH*, uint8_t);
