...
enum {
    WOLFSSH_FILEATRB_SIZE   = 0x00000001,
    WOLFSSH_FILEATRB_UIDGID = 0x00000002,
    WOLFSSH_FILEATRB_PERM   = 0x00000004,
    WOLFSSH_FILEATRB_TIME   = 0x00000008,
...
/* open flags */
enum {
    WOLFSSH_FXF_READ    = 0x00000001,
    WOLFSSH_FXF_WRITE   = 0x00000002,
    WOLFSSH_FXF_APPEND  = 0x00000004,
    WOLFSSH_FXF_CREAT   = 0x00000008,
    WOLFSSH_FXF_TRUNC   = 0x00000010,
