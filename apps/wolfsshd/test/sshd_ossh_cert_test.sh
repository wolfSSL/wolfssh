...
# The suite may run under sudo (CI): this script runs as root while the daemon
# session runs as the login user. Let that user traverse $WORK and write the
# force-command marker via a world-writable marker dir.
chmod 711 "$WORK"
